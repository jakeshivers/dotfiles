# Generated by Powerlevel10k configuration wizard on 2025-06-24 at 21:20 MDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 49619.
# Wizard options: awesome-fontconfig, small icons, rainbow, unicode, 12h time,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    commit_hash status command_execution_time
    vcs                     # git status
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  function prompt_commit_hash() {
    local hash=$(git rev-parse --short HEAD 2>/dev/null)
    [[ -n $hash ]] && p10k segment -b blue -f white -t " $hash"
  }
